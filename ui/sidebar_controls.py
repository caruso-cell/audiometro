...
class SidebarControls(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.environment_panel.selectionChanged.connect(self._emit_environments)
    ...
    def _emit_environments(self, selection: list) -> None:
        self.environmentsChanged.emit(selection)
    ...
    def environments(self) -> list:
        return self.environment_panel.selected()

    def set_environments(self, values) -> None:
        self.environment_panel.set_selected(values)

    def set_environments_enabled(self, enabled: bool) -> None:
        self.environment_panel.set_enabled(enabled)
